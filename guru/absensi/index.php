...
<html lang="en">
    ...
    <body>
        ...
        <script>
            ...
            const keterangans = document.getElementsByClassName("keterangan");
            Array.prototype.map.call(keterangans, keterangan => {
                ...
                keterangan.addEventListener('change', e => {
                    ...
                    if (confirm("Ubah keterangan absensi?")) {
                        form.submit();
                    } else {
            ...
            const btnValid = document.getElementsByClassName("btn-valid");
            Array.prototype.map.call(btnValid, btn => {
                btn.addEventListener("click", e => {
                    if (confirm("Konfirmasi keterangan absensi murid ini?")) {
