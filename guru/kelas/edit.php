<?php 
    ...
    $kelas = getKelas(isset($_GET['i']) ? $_GET['i'] : 0);
?>

<!doctype html>
<html lang="en">
    <head>
        <?php headerHTML("Edit Kelas | Absensi"); ?>
    </head>
    <body>
        <?php tampilHeader(); ?>
        ...
        <div class="container-fluid">
            <div class="row">
                <main role="main" class="m-auto px-md-4 w-75">
                    ...
                    <?php tampilForm("update.php", $kelas); ?>
                </main>
            </div>
        </div>
        ...
        <script>
            ...
            tanggalSelesai(document.getElementById("kelasMulai"), document.getElementById("kelasSelesai"), true);
        </script>
    </body>
</html>